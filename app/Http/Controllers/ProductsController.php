...
class ProductsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Charger les variantes et la catégorie (avec parent) pour décider d'afficher/masquer le prix
        $products = $query->with(['variants', 'category.parent'])->paginate(9)->withQueryString();
    ...
    {
        $product->load(['variants', 'category.parent']);
