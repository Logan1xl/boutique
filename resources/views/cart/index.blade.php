        ...
        <div class="bg-white p-8 rounded-lg shadow-xl">
            @if (count($cart) > 0)
                ...
                <div class="flex justify-end mt-6 space-x-4">
                    ...
                    <a href="{{ route('checkout.index') }}" class="py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 transition duration-300">
                        <i class="fas fa-credit-card mr-1"></i> Acheter
                    </a>
                </div>
