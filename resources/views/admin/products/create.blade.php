        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                @error('description') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                 ...
                 <div class="mb-6">
                <label for="description" class="block text-sm font-medium text-gray-700">Utilisation recommandée <span class="text-red-500">*</span></label>
                <textarea name="description" id="description" rows="5" required
                    class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 p-2"
                >{{ old('description') }}</textarea>
                @error('description') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
            ...
            <div class="mb-6">
                <label for="features" class="block text-sm font-medium text-gray-700">Caractéristiques (séparées par des virgules)</label>
            ...
            <div class="mb-6">
                <label for="technical_info" class="block text-sm font-medium text-gray-700">Informations Techniques (Opt.)</label>
                <textarea name="technical_info" id="technical_info" rows="3"
                    class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 p-2"
                >{{ old('technical_info') }}</textarea>
                @error('technical_info') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
            </div>
