        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 bg-white p-6 md:p-8 rounded-lg shadow-xl">
                ...
                <form action="{{ route('checkout.store') }}" method="POST">
                    ...
                    <div class="mt-8">
                         <button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-lg font-medium text-white bg-green-600 hover:bg-green-700 transition duration-300">
                            <i class="fas fa-money-check-alt mr-2"></i> Acheter
                        </button>
                    </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white p-6 rounded-lg shadow-xl sticky top-4">
                    ...
                    {{-- Liste des articles avec image et nom --}}
                            ...
                            <div class="flex items-center justify-between text-sm">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-gray-500">Quantité: x{{ $item['quantity'] }}</span>
                                    </div>
                                </div>
                                <span class="text-gray-900 font-semibold">{{ number_format(($item['promotion_price'] ?? $item['price']) * $item['quantity'], 0, ',', ' ') }} FCFA</span>
                            </div>
                        @endforeach
                    </div>
