...
class CategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Category::create([
            ...
            'slug' => Str::slug('Peinture Décorative Intérieure'),
        ...
        Category::create([
            ...
            'slug'=>Str::slug('Peinture à Eau Extérieure'),
            'parent_id'=>$peinture->id
        ]);

        Category::create([
            'name'=>'Peinture à huile',
            'slug'=>Str::slug('Peinture à huile'),
            'parent_id'=>$peinture->id
        ]);
        Category::create([
            'name'=>'Antirouille',
            'slug'=>Str::slug('Antirouille'),
            'parent_id'=>$peinture->id
        ]);
        Category::create([
            'name'=>'Enduits',
            'slug'=>Str::slug('Enduits'),
            'parent_id'=>$peinture->id
        ]);
        Category::create([
            'name'=>'Colorants',
            'slug'=>Str::slug('Colorants'),
            'parent_id'=>$peinture->id
        ]);
        Category::create([
            'name'=>'Peinture à eau Intérieur-Extérieure',
            'slug'=>Str::slug('Peinture à eau Intérieur-Extérieure'),
            'parent_id'=>$peinture->id
        ]);
        Category::create([
            'name'=>'Enduits Intérieur-Extérieure',
            'slug'=>Str::slug('Peinture Intérieur-Extérieure'),
            'parent_id'=>$peinture->id
        ]);
        ...
        Category::create([
            'name' => 'Sous-couche sablées',
            'slug' => Str::slug('Sous-couche sablées'),
            'parent_id' => $membranes->id
        ]);
        Category::create([
            'name' => 'Granulée',
            'slug' => Str::slug('Granulée'),
            'parent_id' => $membranes->id
        ]);
        // ... (etc)
    }
